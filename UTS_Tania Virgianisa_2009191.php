  ...
  <body>
    ...
    <section>
		...
		<nav class="navbar fixed-top navbar-expand-lg">
           ...
           <a href="https://www.upi.edu/" class="navbar-brand fixed">
            <img src="LOGO-UPI.jpg" width="50" class="rounded-circle" alt="Sistem Informasi Kelautan" class="img-responsive">
        </a>
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav my-2 my-lg-0 navbar-nav-scroll ms-auto" style="--bs-scroll-height: 100px;">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Profil </a>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
             <h2>Tentang Kampus</h2>
              <p>Universitas Pendidikan Indonesia Prodi Sistem Informasi Kelautan di Jl. Ciracas No.38, Serang, Kec. Serang, Kota Serang, Banten 42116 - Indonesia dan termasuk Kampus Daerah</p>
              <a class="btn btn-primary" href="http://kd-serang.upi.edu/" role="button">Selengkapnya</a>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
              <h2>Perpustakaan</h2>
              <p>Perpustakaan Universitas Pendidikan Indonesia (UPI) lahir pada tanggal 20 Oktober 1954 di bawah naungan Perguruan Tinggi Pendidikan Guru (PTPG), di Hotel Homann Jl. Asia Afrika Bandung 1954.</p>
              <a class="btn btn-primary" href="http://perpustakaan.upi.edu/profil-perpustakaan-upi/" role="button">Selengkapnya</a>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">  
             <h2 style="text-align: left;">Kegiatan Mahasiswa</h2>
              <p style="text-align: left;">Ada banyak kegiatan mahasiswa yang diadakan oleh HIMATASKA. Salah satunya adalah kegiatan MABIM yang dilaksanakan setiap tahun. </p>
              <a class="btn btn-primary left" href="http://sik.kd-serang.upi.edu/?p=630" role="button" >Selengkapnya</a>
            </div>
          </div>
        </div>
    ...
    <div class="row ">
        <div class="col-md-4 mb-3">
            <h2>Berita</h2>
              <p class="card-text">Mahasiswa Sistem Informasi Kelautan (SIK) angkatan 2019 Amelia Luthfi Kamil berhasil diterima pada Program Pejuang Muda 2021. Pejuang Muda adalah laboratorium sosial bagi para mahasiswa mengaplikasikan ilmu dan pengetahuannya untuk memberi dampak sosial secara konkret. Melalui Program setara 20 SKS ini, mahasiswa akan ditantang untuk belajar dari warga sekaligus berkolaborasi dengan Pemerintah Daerah, pemuka masyarakat, tokoh agama setempat serta seluruh stakeholder penggerak sosial di daerah.</p>
              <a href="http://sik.kd-serang.upi.edu/?p=2341">Selengkapnya</a>
            </div>
        <div class="col-md-4 mb-3">
            <h2>Kemahasiswaan</h2>
              <p class="card-text">Program Studi Sistem Informasi Kelautan (SIK) dan Himpunan Mahasiswa Sistem Informasi Kelautan (HIMATASKA) setiap bulannya melaksanakan MATAKA. Pelaksanaan MATAKA ini bertujuan agar terbentuknya suasana akademik di Program Studi Sistem Informasi Kelautan.</p>
              <a href="http://sik.kd-serang.upi.edu/?p=2346">Selengkapnya</a>
            </div>
        <div class="col-md-4 mb-3">
            <h2>Himataska</h2>
              <p class="card-text">HIMATASKA merupakan singkatan dari Himpunan Mahasiswa Sistem Informasi Kelautan. Himpunan ini merupakan wadah organisasi bagi mahasiswa yang ada pada program studi SIK.</p>
              <a href="https://www.instagram.com/himataska/">Selengkapnya</a>
          </div>  
      </div>
    </div>
  </section>
    ...
    <section>
        <div class="container">
            ...
            <button type="button" class="btn btn-primary" align="left"><a href="http://sik.kd-serang.upi.edu/?page_id=426"> <b> Selengkapnya </b> </a></button>
            </div>
           </div>
         </div>
        </br>
      ...
      <div class="row gx-5">
        <div class="col">
         <div class="p-3 border bg-light" style="color: black;">
          ...
          <p>Javascript adalah bahasa program yang bisa kita gunakan pada frontend (bagian depan) website sehingga website akan menjadi lebih interaktif dan mempunya logika untuk berpikir.
          </p>
    ...
    <section>
        <div class="container" id="contact">
            <div class="row justify-content-center fs-6">
                <div class="col-4">
				<div class="col-lg-10" > Tanyakan Sesuatu  <br> </div>
                  <form>
                    <div class="mb-3">
    ...
    <div class="container">
      <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        <div class="col-md-4 d-flex align-items-center">
          ...
          <span class="text-muted">©️ 2021 Tania Virgianisa_2009191_SIK'20</span>
        </div>
      </footer>
    </div>
